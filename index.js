const MoviesData = {
  ...
  function displayMovies(page) {
    listMovies.innerHTML = ''; // Clear the previous movies
    ...
    page.results.forEach((element) => {
      ...
      // Add click event to toggle Favourites
      heartLiked.addEventListener('click', () => {
        ...
        if (!isFavorite) {
          ...
          if (index !== -1) {
            Favourites.splice(index, 1); // Remove from Favourites array
          }
  ...
  function displayPage(pageNumber) {
    ...
    // Determine which page object to use
